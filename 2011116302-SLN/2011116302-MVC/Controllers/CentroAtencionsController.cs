...
namespace _2011116302_MVC.Controllers
{
    public class CentroAtencionsController : Controller
    {
        ...
        {
            // ViewBag.DireccionId = new SelectList(db.Direccions, "DireccionId", "DescripcionDireccion");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "CentroAtencionId,DireccionId,NombreCeAtencion")] CentroAtencion centroAtencion)
        {
            ...
            // ViewBag.DireccionId = new SelectList(db.Direccions, "DireccionId", "DescripcionDireccion", centroAtencion.DireccionId);
            return View(centroAtencion);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CentroAtencionId,DireccionId,NombreCeAtencion")] CentroAtencion centroAtencion)
        {
            if (ModelState.IsValid)
            {

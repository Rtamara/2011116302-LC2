...
namespace _2011116302_MVC.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ClienteId,NombreCliente,ApePaternoCliente,ApeMaternoCliente,DniCliente,FecNacimientoCliente,SueldoCliente,CorreoCliente")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ClienteId,NombreCliente,ApePaternoCliente,ApeMaternoCliente,DniCliente,FecNacimientoCliente,SueldoCliente,CorreoCliente")] Cliente cliente)
        {
            if (ModelState.IsValid)
            {

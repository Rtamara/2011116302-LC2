...
namespace LineaTelefonica.WebAPI.Controllers
{
    public class AdministradorLineasApiController : ApiController
    {
        ...
        public IHttpActionResult Get()
        {
            ...
            var AdministradorLineas = _UnityOfWork.AdministradorLineas.GetAll();
        ...
        public IHttpActionResult Update(int id, AdministradorLineaDTO administradorLineaDTO)
        {
            ...
            var administradorLineaInPersistence = _UnityOfWork.AdministradorLineas.Get(id);
        ...
        public IHttpActionResult Delete(int id)
        {
            ...
            var administradorLineaInDataBase = _UnityOfWork.AdministradorLineas.Get(id);
            if (administradorLineaInDataBase == null)
                return NotFound();

            _UnityOfWork.AdministradorLineas.Delete(administradorLineaInDataBase);
            _UnityOfWork.SaveChanges();
